...
<body>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-3" id="leftCol" style="position: fixed;">

				<div class="well">
					<ul class="nav nav-stacked" id="sidebar">
						<li><a href="#sec1">Elapsed time on page</a></li>
						<li><a href="#sec2">Average elapsed time</a></li>
						<li><a href="#sec3">Clicks on page</a></li>
					</ul>
				</div>

			</div>
			<div class="col-md-9 col-md-offset-4"">
				<h2 id="sec1">Elapsed time on page</h2>
				<p>Shows a distribution of time amount spent by users on a page.</p>
				<p>Rem aperiam, eaque ipsa quae ab illo inventore veritatis et
					...
					non numquam eius modi tempora incidunt ut labore et dolore magnam
					aliquam quaerat voluptatem. Ut enim ad minima veniam, quis nostrum
					exercitationem ullam corporis suscipit laboriosam, nisi utstrum
				...
				<h2 id="sec3">Clicks on main page</h2>
