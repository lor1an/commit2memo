var _carbonads = {
	init : function(where) {
		...
		pro.src = '//' + baseurl + '/ads/' + serve + '.json?segment=placement:'
				+ placement + '&callback=_carbonads_go';
		var ck = '';
		try {
			ck = document.cookie
		} catch (e) {
		...
		;
		var day = ck.indexOf('_bsap_daycap='), life = ck
	...
	getServe : function(serve, placement) {
		var skip = [ '978gs', 'aaronrussellcouk', 'abundantcodecom',
				'alexyoungorg', 'alphapixelscom', 'amiresponsivedesignis',
				'andrewdumontme', 'appscreensco', 'asymco',
				'beautifulpixelscom', 'benevanscom', 'benhowdle', 'blockio',
				'blogdavidtateorg', 'blogechoenduringcom', 'bloggarstasiocom',
				'blogshaydesdsgncom', 'bootstrapstage',
				'bootstrapvalidatorcom', 'bootswatchcom', 'bootzee',
				'brdrckme', 'byteswirecom', 'cferdinandigithubiokraken',
				'chainso', 'codepen', 'cooldesignjobscom', 'css3gencom',
				'cssstatscom', 'csstypesetcom', 'cube3x', 'damiannicholsoncom',
				'danluucom', 'davidchartiercom', 'dbtek', 'designspiration',
				'dogechaininfo', 'drewsymocom', 'drublicde', 'dzyngiricom',
				'finerthingsin-archived', 'freshas', 'fribbblecom',
				'geekingspreecom', 'geocoderca', 'getskeletoncom',
				'gomakethingscomblog', 'gotoandlearn', 'grackcom',
				'hackerbracket', 'hawkeecom', 'hellomrperez', 'htmlsig',
				'iconiicom', 'ihatetomatoesnet', 'inspectelementcom',
				'johnpolacekcom', 'jsdbio', 'jshintcom', 'kilianvalkhofcom',
				'laravel', 'launchbyte', 'launchingnext', 'leebrimelow',
				'leostartsupcom', 'lovebootstrapcom', 'markitupjaysalvatcom',
				'markoprljictumblrcom', 'materialupcom', 'mathiasbynensbe',
				'matmartinez', 'merowinginfo', 'middlemanappcom',
				'mmminimalcom', 'mobileosgeek', 'motionographercom',
				'newstartupscom', 'nomadlistcom', 'noteandpointcom',
				'npmstatcom', 'osvaldas', 'packalorg', 'pastieorg', 'pydocnet',
				'sassmeister', 'scottksmithcom', 'septemberindustrycouk',
				'shirtmockupcom', 'stierncom', 'stoweboydcom',
				'stugreenhamcomblog', 'taylordavidsoncomwriting', 'techslides',
				'thebootstrapthemescom', 'thedreamercc', 'theinstructionalcom',
				'thenameapp', 'tnycz-delete', 'tympanusnet', 'webjobbingcom',
				'wppbio', 'wwwbuildinternetcom', 'wwwravelrumbacom',
				'wwwsqlreplcom', 'xtermit' ];
...
function _carbonads_go(b) {
	...
	el.innerHTML = '<span class="carbon-wrap"><a href="'
			+ fulllink
			+ '" class="carbon-img" target="_blank"><img src="'
			+ ad.image
			+ '" alt="" border="0" height="100" width="130" style="max-width:130px;" /></a><a href="'
			+ fulllink + '" class="carbon-text" target="_blank">'
			+ ad.description + '</a></span>';
